...
2. Open the `valentine.html` file in any modern web browser (Chrome, Safari, Edge, Firefox).
3. Try to click "No"!

## Customization

If you want to reuse or customize this code, you can easily change the following in the `valentine.html` file:

* **The Name:** Search for `Rudra` in the HTML body and replace it with your own name.
* **The Emojis:** In the JavaScript, look for the `createBackgroundHeart()` and `createConfetti()` functions to swap out the arrays of emojis (e.g., `['❤️', '💖', '💕', '🌸']`).
